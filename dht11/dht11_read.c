...
// to spin in a loop before bailing out and considering the read a timeout.
// This should be a high value, but if you're running on a much faster platform
// than a Raspberry Pi or Beaglebone Black then it might need to be increased.
